...
SUBSCRIBED_PLAYLISTS = [S_MISC_PLAYLIST_ID, S_ELV_PLAYLIST_ID, S_AVL_PLAYLIST_ID, SCVC_PLAYLIST_ID, SCVC_DRILLS_PLAYLIST_ID, SOPD_PLAYLIST_ID, S_RED_PLAYLIST_ID]
